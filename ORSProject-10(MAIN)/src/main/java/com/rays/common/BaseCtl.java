 ...
 * 
 * This controller provides generic methods for: - Save (Add/Update) - Get by Id
 * - Delete multiple records - Search records with pagination
 * 
 * @author Vedik
 *
 * @param <F> Form class
...
public class BaseCtl<F extends BaseForm, T extends BaseDTO, S extends BaseServiceInt<T>> {
	...
	/**
	 * Set user context from session. If session does not contain user then default
	 * user is created.
	 * 
	 ...
	 * @return ORSResponse containing validation errors
	 */
	 ...
	 * @param bindingResult validation result
	 * @return ORSResponse containing result message
	 */
	@PostMapping("/save")
	 ...
	 * 
	 * @param id record id
	 * @return ORSResponse containing DTO data
	 */
	@GetMapping("get/{id}")
	 ...
	 * @param form   search form
	 * @param pageNo page number
	 * @return ORSResponse containing list of records
	 */
